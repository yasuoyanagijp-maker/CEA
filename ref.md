...
`backend/config/cost-common.js`。薬価は公定薬価（くすりすと/Xlib 掲載、2025-05 ユーザー確認）。

| 薬剤 | 薬価（円/キット） |
|------|-------------------|
| ラニビズマブ（ルセンティス 0.5mg キット） | 92,753 |
| アフリベルセプト（アイリーア 2mg） | 113,912 |
| アフリベルセプト 8mg | 145,718 |
| ファリシマブ | 141,784 |
| ブロルシズマブ（ベオビュ キット） | 103,163 |
| ラニビズマブ BS | 72,136 |
| アフリベルセプト BS（NIT キット） | 67,959 |
